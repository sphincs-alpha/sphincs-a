                          ...
                          uint32_t fors_leaf_addrx4[4*8])
{
    ...
    for (uint32_t i = start; i <= end; i++)
    {
        ...
        fors_next_leafx4(out,out+1*SPX_N,out+2*SPX_N,out+3*SPX_N,
                            out,out+1*SPX_N,out+2*SPX_N,out+3*SPX_N,
                            ...
                            uint32_t addr_idx, void *info)
{
    ...
    fors_gen_nodex4(leaf,leaf,1, SPX_FORS_W, pub_seed, fors_leaf_addrx4);
