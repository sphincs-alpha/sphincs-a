...
static void wots_gen_pkx8(unsigned char *pk, const unsigned char *seed,
...
int main()
{
    ...
    //MEASURE("  - WOTS pk gen 8x.. ", (1 << SPX_TREE_HEIGHT) / 8, wots_gen_pkx8(wots_pk, sk, pk, (uint32_t *) addr));
    ...
    //MEASURE("  - WOTS pk gen x8.. ", SPX_D * (1 << SPX_TREE_HEIGHT) / 8, wots_gen_pkx8(wots_pk, sk, pk, (uint32_t *) addr));
...
static void wots_gen_pkx8(unsigned char *pk, const unsigned char *seed,
    ...
    wots_gen_leafx8(pk, seed, pub_seed, 0, &leaf);
}*/
